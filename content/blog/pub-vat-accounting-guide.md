...
slug: "pub-vat-accounting-guide"
publishedDate: 2025-11-10
excerpt: "A plain-English primer on pub VAT, bookkeeping, and tax mistakes. Know what to ask your accountant before they have to ask you."
...
voiceSearchQueries:
  - "do pubs pay VAT on food?"
  - "when does a pub need to register for VAT?"
  - "what can a pub reclaim VAT on?"
  - "how do I find a good pub accountant?"
  - "what VAT rate do pubs pay on drinks?"
faqs:
  - question: "Do pubs pay VAT on food?"
    answer: "It depends on how the food is served. Hot food and anything eaten on the premises carries 20 percent VAT. Cold takeaway food, such as a sandwich bought to take away, is zero-rated. Most pub food is served hot and eaten in, so the standard 20 percent rate applies to the majority of your food sales."
  - question: "When does a pub need to register for VAT?"
    answer: "You must register for VAT when your taxable turnover exceeds 90,000 pounds in any rolling 12-month period, or when you expect it to exceed that threshold in the next 30 days alone. Most pubs pass this threshold quickly. You can also register voluntarily below the threshold if reclaiming input VAT would benefit you."
  - question: "What can a pub reclaim VAT on?"
    answer: "You can reclaim VAT on most business purchases including stock from non-tied suppliers, equipment, repairs and maintenance, professional fees, marketing costs, cleaning supplies, and utilities. You cannot reclaim VAT on business entertainment or on items not used for the business. Keep every receipt and invoice."
  - question: "How much does a hospitality accountant cost?"
    answer: "Expect to pay between 150 and 400 pounds per month for a hospitality-specialist accountant handling your bookkeeping, VAT returns, and annual accounts. Some charge more for payroll. A good one will recover significantly more than their fee through legitimate tax planning and VAT recovery."
  - question: "What is the flat rate VAT scheme for pubs?"
    answer: "The flat rate scheme lets you pay a fixed percentage of gross turnover to HMRC instead of calculating the difference between output and input VAT. For pubs the flat rate is typically 6.5 percent. It simplifies admin but you cannot reclaim input VAT on most purchases, so it only suits pubs with low input costs."
  - question: "Do I need to use Making Tax Digital for my pub?"
    answer: "Yes. All VAT-registered businesses must keep digital records and submit VAT returns through Making Tax Digital compatible software. From April 2026 this extends to income tax self-assessment for sole traders and landlords earning over 50,000 pounds. Speak to your accountant about getting compliant."
ctaSettings:
  ctaType: "contact"
