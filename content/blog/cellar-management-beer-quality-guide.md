---
title: "Cellar Management: How to Keep Your Beer Perfect and Your Waste Low"
slug: "cellar-management-beer-quality-guide"
publishedDate: 2025-10-20
excerpt: "A practical cellar management guide for pub landlords. Temperature control, line cleaning, stock rotation, and wastage tracking to protect your GP."
...
voiceSearchQueries:
  - "how do I manage a pub cellar properly?"
  - "what temperature should cask ale be stored at?"
  - "how often should pub beer lines be cleaned?"
  - "how do I reduce beer waste in my pub?"
faqs:
  - question: "What temperature should a pub cellar be?"
    answer: "A pub cellar should be maintained at 11 to 13 degrees Celsius for cask ale. Keg products need to be served colder, typically 3 to 5 degrees, which is handled by the cooling system on the font rather than the cellar temperature itself. If your cellar regularly exceeds 14 degrees, cask ale will condition too fast, go cloudy, and pour with excessive fobbing."
  - question: "How often should beer lines be cleaned in a pub?"
    answer: "Beer lines should be cleaned every seven days without exception. This is the industry standard recommended by the BII and all major breweries. Neglecting line cleaning leads to yeast build-up, off-flavours, and increased wastage from fobbing. A weekly clean takes roughly 30 to 45 minutes for a typical pub cellar and should be logged in a cleaning schedule."
  - question: "What is an acceptable level of beer wastage in a pub?"
    answer: "Industry benchmarks suggest total beer wastage should be between 2 and 3 percent of total volume. This includes ullage from cask conditioning, line cleaning waste, and operational spillage. If your wastage regularly exceeds 4 percent, there is almost certainly a cellar management, line cleaning, or stock rotation problem that needs investigating."
