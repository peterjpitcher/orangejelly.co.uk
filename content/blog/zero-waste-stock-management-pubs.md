...
tags:
  ...
  - "sustainability"
status: "published"
featuredImage: "/images/blog/zero-waste-stock-management-pubs.svg"
...
hasQuickAnswer: true
hasQuickStats: false
localSEO: {"localModifiers":["gastropub","kitchen","survival"],"nearbyLandmarks":["Cardiff","Swansea","Newport"],"targetLocation":"South Wales"}
voiceSearchQueries:
...
## Mini FAQ
**Do I need software?**
Not to start. Google Sheets plus disciplined people beat expensive platforms poorly used. Upgrade only when the basics are second nature.
