---
title: "Profitable Pub Food: 12 Dish Types and the GP Maths (2026)"
slug: "profitable-pub-food-menu-ideas"
publishedDate: 2025-03-13
updatedDate: "2026-08-09T00:00:00.000Z"
excerpt: "The high-margin dishes that genuinely make money in a UK pub, the gross profit maths behind them, and how to cut a menu back to what actually pays its way."
...
tags:
  ...
  - "menu development"
status: "published"
metaDescription: "Profitable pub food worked properly: 12 dish types, UK GP benchmarks, a VAT-correct costing example, and how to price up without losing your regulars."
keywords:
  - "profitable pub food"
  - "high margin pub dishes"
  - "pub food GP"
  - "most profitable bar food"
  - "pub menu ideas"
  - "food cost percentage for pubs"
  - "menu engineering for pubs"
hasFAQs: true
hasQuickAnswer: true
hasQuickStats: true
quickStats:
  - label: "Blended food GP to aim for"
    value: "68-72%"
  - label: "Overstatement if you forget VAT"
    value: "5-7 points"
  - label: "Cash GP on a side of chips"
    value: "£3.20"
localSEO: {"localModifiers":["near me","local","in my area"],"nearbyLandmarks":["Heathrow","Staines","M25"],"targetLocation":"Surrey"}
voiceSearchQueries:
  - "What are the most profitable pub food items"
  - "What GP should pub food be"
  - "How do I work out the GP on a dish"
  - "Do I take VAT off before working out food GP"
  - "How many dishes should a pub menu have"
  - "Is a Sunday roast profitable"
  - "How do I put pub food prices up without losing regulars"
faqs:
  - question: "What are the most profitable pub food items?"
    answer: "Sides, pizza, loaded fries and burgers carry the strongest gross profit in a UK pub kitchen, typically 68 to 87 percent, because the ingredient cost is low and the prep is short. Pies and braises from cheap cuts sit close behind at 68 to 74 percent, because one batched daytime cook feeds several menu lines. Sides are the quiet winner: chips costing around 55 pence sell at four pounds fifty, which is almost pure incremental cash on a cover already sitting down."
  - question: "What gross profit should pub food achieve?"
    answer: "Aim for 68 to 72 percent blended food GP in a food-led pub, or 65 to 70 percent on a shorter wet-led menu. Individual dishes vary widely, so judge the blend rather than any single plate. At The Anchor, costing every dish ex-VAT, cutting the menu back, cross-using ingredients and pricing on true cost rather than on competitors grew our food revenue by 98% in three months."
  - question: "Do I take VAT off before calculating food GP?"
    answer: "Yes, and both sides of the sum must be net. Divide your menu price by 1.2 to get the ex-VAT selling price, then subtract the net plate cost from your supplier invoice. Working GP on the VAT-inclusive price overstates a typical main by five to seven points, and it flatters you most on the dishes where your costs are highest."
  - question: "How many dishes should a pub menu have?"
    answer: "Most pub kitchens run better on around 30 to 35 dishes than on 55. In my experience cutting a bloated menu back lifts gross profit by two to four points and noticeably speeds ticket times, because you buy in bigger volumes, carry fewer part-used packs and throw less away. Keep the dishes that clear their popularity threshold, plus a deliberate handful you intend to promote hard."
  - question: "Is a Sunday roast actually profitable?"
    answer: "Yes, but not on gross profit percentage. A beef roast runs 55 to 65 percent GP, which looks poor next to a side of chips at 85 percent. Judge it on cash gross profit per chef hour instead: prep is fully batched, the menu is short and demand lands in one concentrated session, which usually makes Sunday the best commercial decision in your week."
  - question: "Should I match Wetherspoons on food prices?"
    answer: "No. We are 30 minutes from a Wetherspoons and the answer is still no. Their buying power and site economics are nothing like yours, so matching them hands away your margin without winning the customer who was going there anyway. Compete on what a chain cannot copy: a cooked-to-order plate, a landlord who knows the room, and a short menu executed well."
ctaSettings:
  ctaType: "contact"
  ctaHeading: "Want a Menu That Pays Its Way?"
...
schema:
  ...
  "@type": "Article"
---
# Profitable Pub Food: 12 Dish Types and the GP Maths (2026)
