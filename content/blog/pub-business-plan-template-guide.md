...
slug: "pub-business-plan-template-guide"
publishedDate: 2025-06-09
excerpt: "A step-by-step guide to writing a pub business plan that banks, breweries, and landlords actually approve. Free template included."
quickAnswer: "A solid pub business plan covers six sections: executive summary, market analysis, operations, marketing, financials, and team. Banks want to see realistic revenue forecasts, GP targets of 65-70% on food, and proof you understand your local market. Download our free template to get started."
...
keywords:
  ...
  - "pub financial projections"
hasFAQs: true
hasQuickAnswer: true
hasQuickStats: false
localSEO: {"localModifiers":["near me","local","independent"],"nearbyLandmarks":["London","Leeds","Birmingham"],"targetLocation":"United Kingdom"}
voiceSearchQueries:
  - "How do I write a pub business plan"
  - "What should a pub business plan include"
  - "Do I need a business plan for a pub"
  - "How to get a brewery tenancy"
  - "What do banks want in a pub business plan"
  - "Free pub business plan template"
faqs:
  - question: "How long should a pub business plan be?"
    answer: "Aim for 15 to 25 pages including appendices. Banks and breweries want enough detail to assess risk, but not a novel. Lead with a strong two-page executive summary so busy readers get the headline picture fast."
  - question: "Do I need a business plan if I already run a pub?"
    answer: "Yes. A business plan is not just for start-ups. Existing licensees use them to secure refurbishment loans, renegotiate tenancy terms, apply for new sites, or simply get clarity on where the business is heading. If you are running without one, you are flying blind."
  - question: "What financial projections do banks want to see?"
    answer: "Banks expect a 12-month profit and loss forecast, a cash flow projection showing monthly ins and outs, and a break-even analysis. They want to see you have accounted for seasonality, VAT, and a realistic ramp-up period rather than hockey-stick optimism."
  - question: "How do I forecast revenue for a pub I have not run yet?"
  ...
  - question: "Can I use your template for a brewery tenancy application?"
    answer: "Absolutely. The template covers every section major pub companies request, including personal background, financial projections, marketing strategy, and operational plans. Adapt the language to match the specific brewery application form, but the substance is the same."
  - question: "What is the biggest mistake people make in pub business plans?"
    answer: "Over-optimistic revenue projections in year one. New operators assume full capacity from week one, forget seasonality, and underestimate how long it takes to build regular trade. Start conservative, include a contingency buffer of at least 10 percent, and show the bank you have thought about what happens when trade is slow."
ctaSettings:
  ctaType: "contact"
  ctaHeading: "Get Your Free Pub Business Plan Template"
  ctaButtonText: "Request the Template"
...
If you want hands-on help building your plan, we charge £62.50 plus VAT an hour, with no packages, so you only pay for the hours it takes. We have been through the process ourselves at The Anchor, and we know what banks and breweries actually look for versus what they say they look for.

## FAQs

**How long should a pub business plan be?**
Aim for 15 to 25 pages including appendices. Banks and breweries want enough detail to assess risk, but not a novel. Lead with a strong two-page executive summary so busy readers get the headline picture fast.

**Do I need a business plan if I already run a pub?**
Yes. A business plan is not just for start-ups. Existing licensees use them to secure refurbishment loans, renegotiate tenancy terms, apply for new sites, or simply get clarity on where the business is heading. If you are running without one, you are flying blind.

**What financial projections do banks want to see?**
Banks expect a 12-month profit and loss forecast, a cash flow projection showing monthly ins and outs, and a break-even analysis. They want to see you have accounted for seasonality, VAT, and a realistic ramp-up period rather than hockey-stick optimism.

**How do I forecast revenue for a pub I have not run yet?**
Start with the premises capacity and realistic covers per session. Cross-reference with average spend data from similar pubs in the area. The Publican Morning Advertiser and BBPA publish benchmarking data. If the pub has trading history, request the last three years of accounts from the agent or brewery.

**Can I use your template for a brewery tenancy application?**
Absolutely. The template covers every section major pub companies request, including personal background, financial projections, marketing strategy, and operational plans. Adapt the language to match the specific brewery application form, but the substance is the same.

**What is the biggest mistake people make in pub business plans?**
Over-optimistic revenue projections in year one. New operators assume full capacity from week one, forget seasonality, and underestimate how long it takes to build regular trade. Start conservative, include a contingency buffer of at least 10 percent, and show the bank you have thought about what happens when trade is slow.

---

A pub business plan is not bureaucracy -- it is the foundation of a profitable pub. Get it right and you will make better decisions, secure better terms, and sleep better at night. Get it wrong, or skip it entirely, and you are gambling with your livelihood. Start with [our free template](/contact) and build from there.
