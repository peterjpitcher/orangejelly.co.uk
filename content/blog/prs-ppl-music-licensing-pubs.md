...
slug: "prs-ppl-music-licensing-pubs"
publishedDate: 2025-08-18
excerpt: "TheMusicLicence explained for pub landlords. What it costs, how fees are calculated by venue size, what is covered, and the penalties for playing music without one."
...
voiceSearchQueries:
  - "how much does a music licence cost for a pub?"
  - "do I need a music licence to play the radio in my pub?"
  - "what is TheMusicLicence for pubs?"
  - "what happens if I play music in my pub without a licence?"
  - "does my pub need PRS and PPL?"
faqs:
  - question: "Do I need a music licence just to play the radio in my pub?"
    answer: "Yes. Any public performance of music requires TheMusicLicence, including playing the radio, streaming from Spotify or Apple Music, or having a TV showing content with music. The only exception is if you are playing music in a private area where no customers or staff can hear it."
  - question: "How much does TheMusicLicence cost for a small pub?"
    answer: "For a typical small pub with a floor area of around 100 square metres, TheMusicLicence for background music costs roughly 500 to 800 pounds per year. The exact fee depends on your rateable value or floor area, your opening hours, and whether you also use music for events, DJs, or live performances."
  - question: "Does TheMusicLicence cover live music and karaoke?"
    answer: "TheMusicLicence covers the right to play or perform copyrighted music in any format, including background music, DJ sets, live performances, and karaoke. However, if you are hosting live music you may also need to check your premises licence conditions for entertainment licensing, which is a separate legal requirement."
  - question: "What happens if I play music without a licence?"
    answer: "PRS for Music and PPL actively enforce licensing. If caught, you will receive a demand for backdated fees and potentially face court action. Fines can run into thousands of pounds, plus legal costs. It is significantly cheaper to get the licence than to risk enforcement."
  - question: "Is Spotify or Apple Music enough to play music in my pub?"
    answer: "No. A personal Spotify or Apple Music subscription is licensed for private use only. Playing it in a commercial venue like a pub requires TheMusicLicence on top of your streaming subscription. Some providers offer commercial streaming plans, but these do not replace TheMusicLicence either."
  - question: "Can I play royalty-free music to avoid needing a licence?"
    answer: "In theory yes, but it is risky. Every track must genuinely be royalty-free and not registered with PRS or PPL. If even one track in your playlist is registered, you are in breach. Most landlords find it simpler and safer to get TheMusicLicence and play whatever they want."
ctaSettings:
  ctaType: "contact"
