...
hasQuickAnswer: true
hasQuickStats: false
localSEO: {"localModifiers":["UK","independent","freehouse"],"nearbyLandmarks":["London","Surrey","Staines"],"targetLocation":"United Kingdom"}
voiceSearchQueries:
...
faqs:
  ...
  - question: "Can I delay a VAT or PAYE payment if my pub cannot afford it?"
    answer: "You can ask HMRC for a Time to Pay arrangement, which spreads the bill over instalments. Contact them before the payment falls due rather than after, because an arrangement agreed in advance can reduce or prevent some late payment penalties. Interest still accrues on the outstanding balance, so treat it as breathing space rather than free credit."
  - question: "Do I have to pay VAT on deposits and gift cards straight away?"
    answer: "For deposits, yes: in hospitality a deposit is normally an advance payment, so the VAT tax point is the moment you receive the money, not the night of the booking. Gift card treatment depends on whether the voucher counts as single or multi-purpose, which turns on whether the VAT rate is known at issue. Ring-fence 20% of every prepayment and confirm the voucher position with your accountant before you launch a scheme."
---
