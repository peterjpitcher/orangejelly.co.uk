...
keywords:
  - "pub loyalty scheme"
  - "hospitality CRM"
  - "retain pub customers"
  - "loyalty card ideas"
  - "pub friday sales"
hasFAQs: true
hasQuickAnswer: true
hasQuickStats: false
localSEO: {"localModifiers":["after work","city","office"],"nearbyLandmarks":["London","Surrey","Staines"],"targetLocation":"United Kingdom"}
voiceSearchQueries:
...
Eight to twelve weeks. Sign-ups tell you about your launch in the first fortnight, but visits per member is the number that proves the scheme changed anything.
