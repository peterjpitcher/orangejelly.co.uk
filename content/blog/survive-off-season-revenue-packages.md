...
tags:
  ...
  - "sales"
status: "published"
featuredImage: "/images/blog/survive-off-season-revenue-packages.svg"
...
hasQuickAnswer: true
hasQuickStats: false
localSEO: {"localModifiers":["coastal","market town","village"],"nearbyLandmarks":["Whitby","Scarborough","Filey"],"targetLocation":"North Yorkshire Coast"}
voiceSearchQueries:
...
## Mini FAQ
**Should I discount heavily midwinter?**
Lead with value (inclusions, exclusive use, set-up support) not slashed prices. Offer weekday incentives only if capacity remains low.

**Do I need new licences for hosted experiences?**
Most add-ons (craft tutors, yoga) just require clear risk assessments. Check PRS/PPL if adding new music elements.
