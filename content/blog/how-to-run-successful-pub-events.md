...
excerpt: "Transform quiet nights into packed events. From planning to promotion, the proven formula for running profitable pub events that build loyal regulars."
...
voiceSearchQueries:
  - "How do I run a successful pub event"
  - "What events work best for pubs"
  - "How do I promote a pub event"
  - "How often should a pub run events"
  - "Do pub events actually make money"
...
faqs:
  ...
  - question: "How far ahead should I promote a pub event?"
    answer: "Start promoting three weeks ahead. Week one: announce and create buzz. Week two: share details and early booking incentives. Week three: final push with countdown posts and personal invites to regulars."
---
...
**Quiz nights** are the single most proven pub event in the UK. Low cost to run, high drink spend, strong repeat attendance. A weekly quiz can add £400-800 to your weekly takings once established. If you haven't started one yet, read our [complete quiz night guide](/guides/quiz-night-ideas) for step-by-step setup.

**Live music** works brilliantly when you match the act to your audience. Acoustic sessions on a Friday or Saturday draw a different crowd and keep people in the pub longer. Budget £150-300 per act and aim to cover it through increased spend. Our guide to [live music events for pubs](/guides/live-music-events-for-pubs) covers how to book acts, manage sound, and make it profitable.
...
**Themed food nights** turn a quiet kitchen into a revenue driver. Curry night, pie and mash, or a monthly steak special give people a specific reason to book. Pair it with a drink deal and you've got a complete evening out. See our [profitable pub food menu ideas](/guides/profitable-pub-food-menu-ideas) for inspiration.

**[Family events](/guides/how-to-attract-families-to-your-pub)** fill weekend daytime slots that many pubs waste. Sunday afternoon quizzes, craft sessions, and seasonal events bring in families who spend £60-80 per table.

### Events for Specific Nights

Different nights need different approaches. Here's what works where:

**Monday:** [Board game nights](/guides/boardgame-night-101) or poker tournaments. Low cost, attracts a niche crowd who become fierce regulars. See our guide to [quiet Monday night promotions](/guides/quiet-monday-night-promotions).

**Tuesday:** [Music bingo](/guides/music-bingo-101) or themed food nights. Tuesday is the hardest night to fill, so you need something with novelty. Read our deep dive into [fixing empty Tuesday nights](/guides/pub-empty-tuesday-nights).

**Wednesday:** Quiz night or [karaoke](/guides/karaoke-night-101). Midweek is quiz territory for a reason: it works. Our [midweek offers guide](/guides/midweek-pub-offers-that-work) has more tactics.

**Thursday:** Tasting evenings or live acoustic. Thursday crowds are ready for the weekend and willing to spend more.

**Friday/Saturday:** Live music, DJs, or [themed party nights](/guides/theme-hour-power-hour). Your busiest nights should have events that extend dwell time and increase per-head spend.
...
For seasonal planning across the full year, our [seasonal pub events calendar](/guides/seasonal-pub-events-calendar) maps out what works month by month. And if you're planning for summer specifically, see our [summer pub event ideas](/guides/summer-pub-event-ideas).
...
For more on building your marketing machine with minimal budget, read our [low-budget pub marketing ideas](/guides/low-budget-pub-marketing-ideas) and [content marketing ideas for pubs](/guides/content-marketing-ideas-pubs).
...
1. **Welcome moment**: Make people feel they've arrived at something. A greeting, a brief intro, setting the scene.
2. **Break or interval**: This is your money moment. People go to the bar.
3. **Upsell cue**: Staff should know exactly when to mention the special, the raffle, or the next event.
4. **Close and rebook**: Always, always announce the next event. "Same time next week" or "our next tasting is on the 15th. Grab your ticket at the bar."
...
If you want to build this into a proper retention system, our guide to [email marketing for pub retention](/guides/email-marketing-pub-retention) covers how to keep customers coming back systematically.

## Step 6: Track What Works and Iterate

After each event, note three things:

1. **Attendance**: How many people came?
2. **Revenue**: What did the till say compared to the same night without an event?
3. **Feedback**: What did people say? What could be better?
...
This gives you a calendar that's manageable but always has something coming up. For a complete annual plan, our [seasonal pub events calendar](/guides/seasonal-pub-events-calendar) maps this out month by month.
...
If you're struggling to work out which event fits your pub, or you want help building the promotion system around it, [get in touch](/contact). You can also explore our [pub marketing](/pub-marketing) for hands-on support. A quick conversation with someone who's been through the same process can cut out weeks of trial and error.
