...
keywords:
  ...
  - "hospitality crisis PR"
  - "pub reputation repair"
  - "google review response"
  - "turn reviews into bookings"
hasFAQs: true
hasQuickAnswer: true
hasQuickStats: false
localSEO: {"localModifiers":["google reviews","tripadvisor","local press"],"nearbyLandmarks":["Brighton","Hove","Worthing"],"targetLocation":"Sussex"}
voiceSearchQueries:
