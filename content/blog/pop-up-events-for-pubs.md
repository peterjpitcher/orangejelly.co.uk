...
tags:
  ...
  - "makers market"
status: "published"
metaDescription: "Pop-up events for pubs that fill quiet nights: street food, guest chefs, makers' markets and themed takeovers, plus how to plan, price, promote and run them."
keywords:
  - "pop up events for pubs"
...
voiceSearchQueries:
  - "What pop up events can I run in my pub"
  - "How do I host a street food pop up in my pub"
  - "How do I find a guest chef for my pub"
  - "What is a pop up event in a pub"
  - "How do I promote a pub pop up event"
faqs:
  - question: "What counts as a pop-up event for a pub?"
    answer: "Any short, one-off takeover that gives people a fresh reason to visit: a street-food trader for one night, a guest chef using your kitchen, a makers' market in the garden, or a themed supper club. It runs once or on a set rhythm rather than every day, which is what makes it feel like an occasion."
  - question: "Do I need a Temporary Event Notice for a pop-up?"
    answer: "Usually not. If a trader serves food within your normal licensed hours and footprint, you are covered by your existing premises licence. You only need a Temporary Event Notice if you extend your hours or trade outside your licensed area, such as spilling out into a car park. Check your own licence conditions first."
  - question: "How do I find traders or guest chefs for a pop-up?"
    answer: "Start local. Message street-food traders you have seen at nearby markets, ask your suppliers who they rate, and post in local hospitality and community Facebook groups. Most independent traders are actively looking for covered, marketed venues with a built-in crowd, which is exactly what your pub offers."
  - question: "How often should I run pop-up events?"
    answer: "Pick one format and run it on a predictable rhythm, such as the first Friday of the month, rather than scattering one-offs. Consistency is what turns a pop-up from a gamble into a habit your locals plan around. Monthly is plenty for most pubs while you build the audience."
---
...
If you want a hand picking the right format for your pub or sorting the promotion, that's the kind of thing we help with at Orange Jelly. Have a look at [how we work](/how-we-work), or read the wider [guide to running successful pub events](/guides/how-to-run-successful-pub-events) first. Daytime crowd more your thing? Our [family craft hour guide](/guides/family-craft-hour-101) is a pop-up in its own right.

## FAQs

**What counts as a pop-up event for a pub?**
Any short, one-off takeover that gives people a fresh reason to visit, such as a street-food trader for one night, a guest chef in your kitchen, a makers' market, or a themed supper club. It runs once or on a set rhythm rather than every day, which is what makes it an occasion.

**Do I need a Temporary Event Notice?**
Usually not. If a trader serves food within your normal hours and licensed footprint, your premises licence covers it. You only need a TEN if you extend hours or trade outside your licensed area. Check your own conditions.

**How do I find traders or guest chefs?**
Start local: message traders from nearby markets, ask your suppliers, and post in community and hospitality groups. Most independent traders want exactly what you've got, which is a covered, marketed venue with a built-in crowd.

**How often should I run one?**
Pick one format and run it on a predictable rhythm, like the first Friday of the month. Consistency turns a pop-up from a gamble into a habit. Monthly is plenty while you build the audience.
