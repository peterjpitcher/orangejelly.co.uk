...
slug: "google-business-profile-pub-guide"
publishedDate: 2025-09-22
excerpt: "Step-by-step guide to setting up and optimising your pub's Google Business Profile. Get found in local search, appear in the 3-pack, and turn searchers into customers."
...
voiceSearchQueries:
  - "how do I get my pub on Google Maps?"
  - "how do I set up Google Business Profile for my pub?"
  - "how do pubs rank higher on Google Maps?"
  - "what should I post on my pub's Google Business Profile?"
  - "how do I respond to bad pub reviews on Google?"
faqs:
  - question: "How do I get my pub on Google Maps?"
    answer: "Search for your pub on Google Maps. If it appears, click Claim this business and follow the verification steps. If it does not appear, go to business.google.com, click Add your business, and enter your pub name, address, and category. Google will verify you own the business, usually by sending a postcard with a code to your address. The whole process takes one to two weeks."
  - question: "What categories should I choose for my pub on Google Business Profile?"
    answer: "Your primary category should be Pub. Add secondary categories that match what you actually offer, such as Restaurant, Bar, Live Music Venue, or Event Venue. Do not add categories you cannot deliver on. Google uses these to decide which searches show your listing, so accuracy matters more than volume."
  - question: "How do I get my pub into the Google Maps 3-pack?"
    answer: "The local 3-pack favours pubs with complete profiles, consistent NAP details across the web, regular photo uploads, frequent Google Posts, strong review scores with recent activity, and a website that matches your listing details. There is no shortcut. Consistency and completeness over time is what moves the needle."
  - question: "How often should I post on Google Business Profile?"
    answer: "At least once a week. Posts expire after seven days, so a weekly rhythm keeps your profile active. Share upcoming events, new menu items, seasonal specials, or behind-the-scenes moments. Each post should include a photo, a short description, and a call to action like Book a table or Learn more."
  - question: "Should I respond to negative reviews on Google?"
    answer: "Always. Respond within 24 hours, be professional, acknowledge the issue, and offer to resolve it offline. Never argue publicly. Potential customers read your responses as much as the reviews themselves. A thoughtful response to a negative review can actually build more trust than five stars with no replies."
  - question: "Can I add my pub menu to Google Business Profile?"
    answer: "Yes. Use the Menu section in your profile to add items with descriptions and prices. You can also upload a PDF or link to your website menu. Keep it updated, especially if prices change seasonally. An outdated menu creates a poor first impression before someone even walks through the door."
ctaSettings:
  ctaType: "services"
...
1. Search for your pub name on Google Maps.
2. Click on your listing and look for "Claim this business" or "Own this business?"
3. Click it and follow the verification steps.
...
3. Enter your pub name exactly as it appears on your signage.
4. Enter your full address and confirm the map pin is in the right place.
...
1. **Seed it with your own questions.** Ask and answer the most common things people want to know: "Do you take bookings?" "Is there parking?" "Are dogs allowed?" "Do you show live sport?"
2. **Monitor it weekly.** Set up alerts so you know when new questions appear.
3. **Answer quickly.** If you do not answer, someone else will, and they might get it wrong.
4. **Be factual and helpful.** Short, clear answers. No marketing fluff.
