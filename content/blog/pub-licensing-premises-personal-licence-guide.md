...
slug: pub-licensing-premises-personal-licence-guide
publishedDate: 2025-07-28
excerpt: "Plain-English guide to every licence a pub landlord needs. Premises licences, personal licences, TENs, and how to avoid costly mistakes."
...
voiceSearchQueries:
  ...
  - "how do I get a premises licence for a pub?"
...
faqs:
  - question: "How much does a premises licence cost?"
    answer: "The application fee depends on the rateable value of your premises. For most small to medium pubs the initial fee is between 100 and 635 pounds, with an annual maintenance fee in a similar range. The biggest cost is often the solicitor or licensing consultant you use to prepare the application, which can add 1,000 to 3,000 pounds on top."
  - question: "Can I sell alcohol without a personal licence?"
    answer: "You cannot be named as the Designated Premises Supervisor without a personal licence. However, other staff can sell alcohol under the authority of the premises licence as long as there is a named DPS who holds a personal licence. In practice, every pub landlord should have one."
  - question: "How many TENs can I apply for in a year?"
    answer: "A single premises can have a maximum of 15 TENs per calendar year, covering no more than 21 days in total. A personal licence holder can give 50 TENs per year, while someone without a personal licence can give only 5. Each TEN can cover an event of up to 499 people for up to 168 hours, which is 7 days."
  - question: "How long does it take to get a premises licence?"
    answer: "The statutory consultation period is 28 days from the date the application is properly made. If there are no objections, the licence is usually granted shortly after that. If there are representations from responsible authorities or local residents, a licensing committee hearing is scheduled, which can add 4 to 8 weeks. Budget 2 to 3 months total."
  - question: "What happens if I run an event without a TEN?"
    answer: "Selling alcohol or providing regulated entertainment without the correct authorisation is a criminal offence under the Licensing Act 2003. You could face a fine of up to 20,000 pounds or six months in prison. Your premises licence could also be reviewed and revoked. It is never worth the risk."
  - question: "Do I need a licence for live music in my pub?"
    answer: "Since the Live Music Act 2012, unamplified live music between 8am and 11pm is exempt from licensing for any venue. Amplified live music is exempt for audiences of up to 500 people between 8am and 11pm if your premises already has a premises licence authorising the sale of alcohol. If you want music after 11pm or for larger audiences, you need it on your premises licence or covered by a TEN."
  - question: "Can my premises licence be revoked?"
    answer: "Yes. Any responsible authority or any person can apply for a review of your premises licence at any time. Common triggers include persistent noise complaints, underage sales, crime and disorder, and public safety concerns. At a review hearing the licensing committee can modify conditions, suspend the licence for up to three months, remove the DPS, or revoke the licence entirely."
ctaSettings:
  ctaType: "contact"
  ctaHeading: "Need Help With Your Licensing?"
...
1. **Complete the application form.** This is a standard form available from your local council or the GOV.UK website. It asks for details of the premises, the licensable activities you want to carry out, the proposed hours, and the steps you will take to promote the four licensing objectives.

2. **Prepare an operating schedule.** This is the most important part. It sets out how you will promote the four licensing objectives: the prevention of crime and disorder, public safety, the prevention of public nuisance, and the protection of children from harm. Be specific and practical. Vague promises do not impress licensing committees.

3. **Advertise the application.** You must display a pale blue A4 notice at the premises for 28 consecutive days and place an advertisement in a local newspaper.

4. **Submit to responsible authorities.** Copies of the application go to the police, fire service, environmental health, trading standards, planning, the local safeguarding children board, public health, and the licensing authority itself.

5. **Wait 28 days.** This is the statutory consultation period during which anyone can make representations for or against the application.

6. **If no objections:** the licence is granted as applied for.
...
1. **Complete the Level 2 Award for Personal Licence Holders.** This is a one-day course run by accredited training providers. It covers the Licensing Act 2003, the licensing objectives, and your responsibilities. The course costs between 150 and 250 pounds depending on the provider. You sit a multiple-choice exam at the end.

2. **Apply for a DBS check.** You need a basic Disclosure and Barring Service check, which costs 18 pounds through the DBS website. This takes 1 to 4 weeks to come back.

3. **Apply to your local council.** Submit the application form along with your qualification certificate, DBS check, and two passport photographs. The application fee is 37 pounds.

4. **Declaration.** You must make a declaration about any relevant offences. If you have unspent convictions for relevant offences, the police may object to your application.

5. **Receive your licence.** If there are no objections from the police, the council grants your personal licence, usually within 4 to 6 weeks of application.
...
1. **Complete the TEN form.** Available from your council or the GOV.UK website. It asks for the premises address, the licensable activities, the dates and times, and the expected number of attendees.
...
5. **Wait for objections.** The police and environmental health have 3 working days to object. If they do not object, the TEN takes effect and you can run your event.

6. **If objections are raised against a standard TEN**, a hearing is arranged before the licensing committee. They can allow the TEN, allow it with conditions, or refuse it.
...
If you want a second pair of eyes on your licensing setup, your operating plan, or any part of your pub operations, [talk to Orange Jelly](/contact). We have been through it all at The Anchor and we are happy to help you avoid the mistakes that cost time, money, and sleep.
