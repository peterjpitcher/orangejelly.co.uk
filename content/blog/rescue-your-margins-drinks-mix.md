...
hasQuickAnswer: true
hasQuickStats: false
localSEO: {"localModifiers":["drink menu","craft beer","cocktail bar"],"nearbyLandmarks":["London","Surrey","Staines"],"targetLocation":"United Kingdom"}
voiceSearchQueries:
...
faqs:
  ...
  - question: "How do I calculate GP on a pint of draught beer?"
    answer: "Take the selling price and remove VAT by dividing by 1.2, then subtract your true cost per saleable pint. Divide that gross profit by the ex-VAT price. The word that catches people out is saleable: a 50 litre keg holds around 88 pints in theory, but line cleaning, sediment and froth mean you should build your cost on the pints you actually sell."
  - question: "What measures am I legally allowed to sell wine and spirits in?"
    answer: "Wine sold by the glass must be available in 125ml, and may be sold in 125ml, 175ml or multiples of those. Spirits such as gin, rum, vodka and whisky must be sold in 25ml or 35ml measures, or multiples, and you must pick one house measure rather than mixing them. In both cases a notice stating your measures must be clearly displayed where customers can see it before ordering."
---
