...
Here's the crucial bit: **These strengths are also their weaknesses**. Understanding these gaps is the foundation of any [pub differentiation strategy](/guides/pub-differentiation-strategies).
...
- **Weekly pub quiz** (with personality, not a generic app). See our [quiz night ideas](/guides/quiz-night-ideas)
...
Remember: Wetherspoons sells beverages. You sell belonging. There's room for both, but only one creates customers for life. If you want to go further on carving out your own position, see our guide to [pub differentiation strategies](/guides/pub-differentiation-strategies).
