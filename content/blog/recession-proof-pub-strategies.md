...
tags:
  ...
  - "economic downturn"
status: "published"
metaDescription: "Proven strategies to grow your pub through an economic downturn: cost-cutting, revenue optimisation and community tactics that protect your trade."
keywords:
  - "recession proof pub"
  - "pub survival strategies"
...
voiceSearchQueries:
  - "How do I recession proof my pub"
  - "How do pubs survive an economic downturn"
  - "What should pubs do when customers have less money"
  - "How do I cut costs at my pub without losing quality"
  - "How do I keep customers coming when money is tight"
faqs:
  - question: "Should I cut marketing during a recession?"
    answer: "No. Keep the channels that drive bookings and trim the rest. Pubs that stay visible during downturns capture market share from competitors who go quiet. Focus your spend on the two or three tactics with proven ROI."
  - question: "How do I keep staff morale up during tough times?"
    answer: "Communicate clearly about the situation, share targets so the team knows what good looks like, and celebrate small wins publicly. Transparency builds trust. People can handle hard truths better than uncertainty."
  - question: "Should I discount heavily to keep customers coming?"
    answer: "No. Heavy discounting trains customers to expect low prices and destroys margin. Instead, create bundled offers that feel generous but protect your gross profit. A pie, pint, and pudding deal at £16.95 feels like great value without giving everything away."
  - question: "What should I cut first when trade drops?"
    answer: "Cut the costs your customers never notice before you touch anything they can see. That means checking your business rates bill and rateable value, moving off out-of-contract energy rates, matching rotas to actual demand hour by hour, and stripping slow-selling lines out of the menu. Cutting quality or opening hours first usually costs you more trade than it protects."
  - question: "How do I know if my prices are too high in a downturn?"
    answer: "Look at units sold, not at complaints. If a dish or drink is still selling at the same rate as last year, the price is not the problem. If volume has fallen while everything around it held steady, either the price outran the perceived value or the item was never that popular. Fix the value first: portion, presentation, garnish, service."
  - question: "Should I reduce my opening hours when trade is quiet?"
    answer: "Only after you have looked at the hourly sales data from your EPOS. Closing an hour that covers its own wage cost and holds your regulars' habit is a false economy. Closing a session that loses money every week, and putting that labour into a busier night, protects margin without damaging your reputation."
---
...
**Is it worth raising prices when customers have less money?**
Often yes, on the items where you can visibly raise the value with it. A better garnish, a warmed plate and a confident description carry a 5% price rise far more easily than a flat increase across the board.

**What is the earliest sign a downturn is reaching my pub?**
Usually spend per head, not covers. The room still looks busy, but the second round, the pudding and the coffee stop being ordered. Track spend per head weekly and you will see it weeks before the takings tell you.
