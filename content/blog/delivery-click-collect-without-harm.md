...
keywords:
  ...
  - "hospitality dual service"
  - "ghost kitchen in pub"
  - "food delivery operations"
hasFAQs: true
hasQuickAnswer: true
hasQuickStats: false
localSEO: {"localModifiers":["delivery","takeaway","collection"],"nearbyLandmarks":["London","Surrey","Staines"],"targetLocation":"United Kingdom"}
voiceSearchQueries:
...
faqs:
  ...
  - question: "Do I have to show allergen information on delivery orders?"
    answer: "Yes. Under the Food Standards Agency's distance selling rules, allergen information must be available at two separate points: before the order is placed, on your website or menu, and again when the food is handed over, on a sticker or a printed menu in the bag. The FSA advises keeping online allergen information no more than one click from the menu."
  - question: "Is VAT different on pub delivery and takeaway food?"
    answer: "It can be. Hot takeaway food is standard-rated at 20%, while genuinely cold food taken away is usually zero-rated, with exceptions such as crisps, confectionery and soft drinks. That difference changes the real margin on each dish, so cost your delivery menu on net prices rather than menu prices and check HMRC's catering guidance if you are unsure."
---
...
Not unless you can protect margin through pricing or bundling. Platform discounts rarely build loyalty, because the loyalty attaches to the app rather than to your pub.

**How do I handle slow nights?**
Lift the cap on quiet days, keep the shorter menu and hold the margin rules. Quiet-night delivery is genuinely incremental revenue, which is exactly when the channel earns its keep.
