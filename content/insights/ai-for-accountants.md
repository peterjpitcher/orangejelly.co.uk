...
tags:
  ...
  - Accountancy
  - Operations
problemPage: using-ai-intelligently
targetTerm: ai for accountants
...
faqs:
  ...
  - question: "Is AI safe to use on client data?"
    answer: "It depends entirely on the tool and the contract, and that is a question for your terms, your professional body's guidance and your insurer rather than for a vendor's marketing page. Ask where data is processed, whether it trains a shared model, and what your engagement letters currently say. If you cannot answer those three, you are not ready to pilot anything on live client records."
  - question: "We bought an AI tool and nobody uses it. What went wrong?"
    answer: "Usually one of two things. Either it was bought against a problem the practice did not actually have, or nobody owned the change, so it sat alongside the old process instead of replacing it. Both are fixable, and neither is fixed by buying a different tool."
  - question: "Where does AI make no difference at all?"
    answer: "Anywhere the constraint is commercial rather than operational. If work gets done and under-billed, if the client base is the wrong shape, or if fees have not been reviewed in years, faster production simply produces more unbilled or underpriced work. AI makes a good process quicker and a bad one quicker to fail."
---
...
Work out which one is holding you back first. It is a cheaper piece of work than any implementation, and it is usually a conversation rather than a project. [Let's talk](/start-here), whether or not AI turns out to be any part of the answer.
