      ...
      >
        <div className="mx-auto flex max-w-[1160px] flex-wrap items-center justify-between gap-4 px-8 py-4 pb-[max(1rem,env(safe-area-inset-bottom))]">
          ...
          <div className="flex gap-2">
            {/*
            No override here any more. This used to carry
            `className="!text-oj-cream !border-oj-cream"`, which is the ground rule
            applied once, by hand, in the one place somebody noticed. The ground
            supplies it now, everywhere, including the places nobody noticed.
          */}
