...
export const seoOverrides: Record<string, SeoOverride> = {
  ...
  '/guides/profitable-pub-food-menu-ideas': {
  ...
  '/guides/social-media-strategy-for-pubs': {
  ...
  '/guides/pub-empty-tuesday-nights': {
  ...
  '/guides/facebook-marketing-local-pubs': {
  ...
  '/guides/recession-proof-pub-strategies': {
  ...
  '/guides/compete-with-wetherspoons': {
  ...
  '/guides/how-to-run-successful-pub-events': {
  ...
  '/guides/midweek-pub-offers-that-work': {
  ...
  '/guides/low-budget-pub-marketing-ideas': {
  ...
  '/guides/content-marketing-ideas-pubs': {
  ...
  '/guides/instagram-marketing-for-pubs': {
  ...
  '/guides/christmas-pub-promotion-ideas': {
  ...
  '/guides/seasonal-pub-events-calendar': {
  ...
  '/guides/turnaround-playbook-independent-bars': {
  ...
  '/guides/revenue-levers-struggling-pubs': {
  ...
  '/guides/menu-engineering-lift-average-spend': {
  ...
  '/guides/pub-differentiation-strategies': {
  ...
  '/guides/how-to-attract-families-to-your-pub': {
  ...
  '/guides/pub-health-check-essential-fundamentals-licensee-success': {
  ...
  '/guides/email-marketing-pub-retention': {
  ...
  '/guides/turn-heating-costs-into-winter-wins': {
  ...
  '/guides/double-drinks-profit-without-selling-more': {
  ...
  '/guides/build-loyalty-scheme-fill-pub': {
  ...
  '/guides/cashflow-fixes-when-trade-drops': {
  ...
  '/guides/delivery-click-collect-without-harm': {
  ...
  '/guides/epos-data-revenue-comeback': {
  ...
  '/guides/food-allergies-gdpr-compliance': {
  ...
  '/guides/live-music-events-for-pubs': {
  ...
  '/guides/low-cost-decor-refreshes-new-improved': {
  ...
  '/guides/partnering-local-brands-share-marketing': {
  ...
  '/guides/premium-pub-positioning': {
  ...
  '/guides/pub-event-template-profit-nights': {
  ...
  '/guides/pub-refurbishment-on-budget': {
  ...
  '/guides/quiet-monday-night-promotions': {
  ...
  '/guides/reboot-pub-atmosphere-on-budget': {
  ...
  '/guides/rent-supplier-negotiations-cash-tight': {
  ...
  '/guides/rescue-your-margins-drinks-mix': {
  ...
  '/guides/social-media-tactics-footfall-seven-days': {
  ...
  '/guides/summer-moments-simple-campaigns': {
  ...
  '/guides/survive-off-season-revenue-packages': {
  ...
  '/guides/upselling-secrets-training-scripts': {
  ...
  '/guides/win-back-locals-after-slow-trade': {
  ...
  '/guides/young-people-wont-come-to-your-pub': {
  ...
  '/guides/30-day-action-plan-stabilise-hospitality': {
  ...
  '/guides/energy-bill-shock-cut-venue-costs': {
  ...
  '/guides/restart-quiz-music-sport-roi': {
  ...
  '/guides/staff-motivation-hacks-no-pay-rise': {
  ...
  '/guides/zero-waste-stock-management-pubs': {
  ...
  '/guides/community-outreach-reintroduce-pub': {
  ...
  '/guides/brewery-tie-improve-your-deal': {
  ...
  '/guides/cash-flow-crisis-breaking-cycle': {
  ...
  '/guides/nobody-books-tables-anymore': {
  ...
  '/guides/terrible-online-reviews-damage-control': {
  ...
  '/guides/village-pub-dying-village-survival': {
  ...
  '/guides/kitchen-nightmares-chef-quits': {
  ...
  '/guides/does-your-pub-need-a-website': {
  ...
  '/guides/buying-a-pub-complete-guide': {
  ...
  '/guides/pub-recruitment-hiring-bar-staff': {
  ...
  '/guides/food-hygiene-rating-five-star-guide': {
  ...
  '/guides/pub-business-plan-template-guide': {
  ...
  '/guides/pub-insurance-cover-guide': {
  ...
  '/guides/prs-ppl-music-licensing-pubs': {
  ...
  '/guides/pub-health-safety-checklist': {
  ...
  '/guides/pub-wages-labour-costs-guide': {
  ...
  '/guides/pub-christmas-bookings-fill-december': {
  ...
  '/guides/pub-licensing-premises-personal-licence-guide': {
  ...
  '/guides/how-to-respond-bad-pub-reviews': {
  ...
  '/guides/google-business-profile-pub-guide': {
  ...
  '/guides/cellar-management-beer-quality-guide': {
  ...
  '/guides/pub-halloween-bonfire-night-events': {
  ...
  '/guides/pub-accessibility-welcoming-guide': {
  ...
  '/guides/pub-vat-accounting-guide': {
  ...
  '/guides/pub-drinks-menu-design-guide': {
  ...
  '/guides/pub-toilet-refurbishment-budget-guide': {
  ...
  '/guides/pub-new-years-eve-planning-guide': {
  ...
  '/guides/pub-chalkboard-a-board-ideas': {
  ...
  '/guides/how-much-profit-does-a-pub-make': {
  ...
  '/guides/pub-six-nations-rugby-marketing': {
  ...
  '/guides/pub-marketing-plan-2026-monthly-guide': {
  ...
  '/guides/national-drinks-days-pub-guide': {
  ...
  '/guides/cask-ale-week-pub-guide': {
  ...
  '/guides/macmillan-coffee-morning-pub-guide': {
  ...
  '/guides/autumn-rugby-nations-championship-pubs': {
  ...
  '/guides/christmas-pub-event-ideas': {
  ...
  '/guides/sober-october-low-no-alcohol-pubs': {
