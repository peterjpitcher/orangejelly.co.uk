...
describe('the privacy notice', () => {
  ...
  it('describes surveys: anonymous answers, volunteers by consent, and when their details go', () => {
    ...
    expect(body).toMatch(/We get an email each time someone answers a survey/);
    expect(body).toMatch(/Our lawful basis is your consent/);
    expect(body).toMatch(/delete them 24 months after that survey closes, automatically/);
  });
