...
**Status:** Plan updated locally, not implemented. The earlier authorisation to implement the guide-conversion phase does not silently extend to this new phase. No new migration, live message or deployment is authorised by this document.
