...
Written against: no pricing (D3), entry is always a conversation (D8), primary action "Let's talk" (D11),
...
**Close:** Any one of those is worth an hour of our time and none of yours until it is.

---

## 3. What we work on

**Heading:** six places growth gets stuck.

Six cards, each linking to `/growth-problems/<slug>`:
...
**Heading:** hear. challenge. build. optimise.
...
**Link:** How we work in full → `/how-we-work`
...
- **+828%** Google Search visibility. Create demand.
- **+403%** table bookings. Convert more.
- **+567%** private hire bookings. Create demand.
- **89%** fewer booking no-shows. Protect margin.
- **+98%** food revenue in three months. Protect margin.

**Close:** A pub is not a professional services firm. Demand, conversion, margin and drag behave the same
way in both, which is why the method travels and the tactics do not.

**Link:** See the work → `/results`
