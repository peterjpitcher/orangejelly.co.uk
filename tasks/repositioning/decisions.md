...
| D47 | **Open: D21 versus the founder-operator credibility.** D21 says company voice, never the founder's first person. Sections 17 and 18 of the positioning overview say the founder-led element is central to the differentiation, that clients are buying what the founder has learned to do for himself, and that the brand has permission to say "this isn't theory". Both can hold at once, since company voice can still describe a founder-operator, but the `/about` page is where they meet and it needs Peter's ruling rather than ours. **Recommendation: keep D21's company voice and let the operator credibility come through in what is described rather than in first-person narration.** | 31 Aug 2026 | Open, needs Peter |
